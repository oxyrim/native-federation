...
export function getStoredTheme(): UpTheme | null {
  try {
...
export function getSystemTheme(): UpTheme {
  return typeof matchMedia !== 'undefined' && matchMedia('(prefers-color-scheme: dark)').matches
    ? 'dark'
    : 'light';
}

export function getActiveTheme(): UpTheme {
...
export function applyTheme(theme: UpTheme): UpTheme {
...
export function chartTheme(theme: UpTheme): UpChartTheme {
  return theme === 'dark'
    ? {
